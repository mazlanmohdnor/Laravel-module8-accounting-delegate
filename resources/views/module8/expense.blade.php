...
<div class="alert alert-success alert-dismissible fade in" role="alert">
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            <div class="x_title">
               <h2>Company Expenses<small>Users</small></h2>
               <ul class="nav navbar-right panel_toolbox">
                  <!-- Large modal -->
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target=".add_expense_modal">Add Expenses</button>
...
{{-- add_expense_modal start --}}
<div class="modal fade add_expense_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="gridSystemModalLabel">Insert Expenses</h4>
         </div>
         <div class="modal-body">
            {{-- form start --}}
            <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" method="post" action="{{ url('expense/store') }}">
            {{ csrf_field() }}
               ...
               <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">expense Category</label>
                  <div class="col-md-8 col-sm-8 col-xs-12">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                     <input class="form-control col-md-7 col-xs-12" type="text" name="payee">
                  </div>
               </div>
               <div class="form-group">
