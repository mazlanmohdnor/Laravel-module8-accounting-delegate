...
<head>
  <title>Hatch - Confirm your account!</title>
  <style>
    @font-face {
            font-family: 'Avenir';
              ...
              <table bgcolor="#488dfb" class="head" style="background: #488dfb;" cellpadding="0" cellspacing="0" border="0" border-collapse="collapse" width="100%">
                <tr>
                  <td style="text-align: center;" colspan="3">
                    <h1>Welcome to Module 8</h1>

                  </td>
                </tr>
                <tr>
                  <td colspan="3" style="padding: 0px 80px; font-size: 20px; text-align: center;">Hi, Welcome to Module8, you have been invited to join Module8 Accounting System. Please click the button below to continue.</td>
                </tr>
                <tr>
                  <td width="30%">&nbsp;</td>
                  <td style="text-align: center;" width="40%">
                    <table cellpadding="0" cellspacing="0" border-collapse="collapse" class="button" width="100%">
                      <tr>
                        <td>
                          <a href="{{ url('module8') }}" style="font-size: 15px;">Confirm my email</a>
                        </td>
                      </tr>
                    </table>
                  </td>
